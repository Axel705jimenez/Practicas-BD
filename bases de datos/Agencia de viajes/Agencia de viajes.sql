...
FILENAME ='C:\BD\BD\Agencia de viajes.mdf',
SIZE = 10,
MAXSIZE = 50,
FILEGROWTH = 5)
LOG ON 
(NAME = AgenciaViajes_log,
FILENAME = 'C:\BD\BD\Agencia de viajes.ldf',
SIZE = 5MB,
MAXSIZE = 25MB,
FILEGROWTH = 5MB);
GO
...
INSERT INTO HOTEL(idHotel,nombre, calle, numero, ciudad, telefono, codigohotel, plazadisponible) values (1,'yanido', 'sismo', 1545, 'Monclova', 1234567, '1863554',45)
GO

SELECT *FROM HOTEL
UPDATE HOTEL SET nombre = 'Dessert' WHERE idHotel = 1
GO
SELECT *FROM HOTEL
