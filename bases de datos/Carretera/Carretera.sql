...
ON
( NAME = Carretera_dat,
    FILENAME = 'C:\BD\BD\Carretera.mdf',
    SIZE = 10,
    MAXSIZE = 50,
    FILEGROWTH = 5 )
LOG ON
( NAME = Carretera_log,
    FILENAME = 'C:\BD\BD\Carretera.ldf',
    SIZE = 5MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 5MB 
);
...
INSERT INTO Carretera(idCarretera,nombre) values (1,'saltillo')
GO

SELECT *FROM Carretera
UPDATE Carretera SET nombre= 'Monterrey' WHERE idCarretera = 1
GO
SELECT *FROM Carretera
DELETE FROM Carretera WHERE idCarretera = 1
GO
SELECT *FROM Carretera
