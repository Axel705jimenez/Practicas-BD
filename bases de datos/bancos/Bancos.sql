...
ON
( NAME = Bancos_dat,
    FILENAME = 'C:\BD\BD\bancos.mdf',
    SIZE = 10,
    MAXSIZE = 50,
    FILEGROWTH = 5 )
LOG ON
( NAME = Bancos_log,
    FILENAME = 'C:\BD\BD\bancos.ldf',
    SIZE = 5MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 5MB ) ;
GO
...
INSERT INTO Sucursal(idSucursal,nombre, telefono, calle, estado, numero, colonia, ciudad) values (1,'Axel', 1234567,'camelias', 'Coahuila',1467,'rosario', 'Monclova')
GO

SELECT *FROM Sucursal
UPDATE Sucursal SET nombre = 'Fernando' WHERE idSucursal = 1
GO
SELECT *FROM Sucursal
