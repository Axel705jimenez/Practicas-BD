...
( NAME = AgenciaViajesII_dat,
    FILENAME = 'C:\BD\BD\Agencia de viajes 2T.mdf',
    SIZE = 10,
    MAXSIZE = 50,
    FILEGROWTH = 5 )
LOG ON
( NAME = AgenciaViajesII_log,
    FILENAME = 'C:\BD\BD\Agencia de viajes 2.ldf',
    SIZE = 5MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 5MB ) ;
GO
...
INSERT INTO Cliente(idCliente,nombre, apellidoPaterno, apellidoMaterno, telefono) values (1,'Fernando', 'Aguilar','Hernandez', 1234567)
GO

SELECT *FROM Cliente
UPDATE Cliente SET nombre = 'Axel' WHERE idCliente = 1
GO
SELECT *FROM Cliente
